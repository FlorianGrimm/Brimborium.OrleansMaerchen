...
public class SqlServerInstanceStoreSettings {
    ...
    /// </summary>
    public string OrchestrationStateTableName => $"[{this.SchemaName}].[{this.HubName}{OrchestrationTable}]";

    /// <summary>
    /// The schema nad name of the Work Item table.
    /// </summary>
    public string WorkItemTableName => $"[{this.SchemaName}].[{this.HubName}{WorkitemTable}]";

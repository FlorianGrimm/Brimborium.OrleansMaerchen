...
internal class LinkCollection
{
    ...
    private readonly ConcurrentDictionary<Key, ListenerLink> links;
    ...
    {
        private readonly string fromContainer;
        private readonly string toContainer;
        ...
        {
            return obj is not Key key ? false : this.Equals(key);
        }
    }
}

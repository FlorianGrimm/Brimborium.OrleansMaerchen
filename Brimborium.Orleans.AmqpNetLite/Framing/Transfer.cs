    ...
    internal override void WriteField(ByteBuffer buffer, int index)
    {
        switch (index)
        {
            case 0:
                ...
                break;
            case 1:
                AmqpEncoder.WriteUInt(buffer, this.deliveryId, true);
                break;
            case 2:
                AmqpEncoder.WriteBinary(buffer, this.deliveryTag, true);
                break;
            case 3:
                AmqpEncoder.WriteUInt(buffer, this.messageFormat, true);
                break;
            case 4:
                AmqpEncoder.WriteBoolean(buffer, this.settled, true);
                break;
            case 5:
                AmqpEncoder.WriteBoolean(buffer, this.more, true);
                break;
            case 6:
                AmqpEncoder.WriteUByte(buffer, (byte)this.rcvSettleMode);
                break;
            case 7:
                AmqpEncoder.WriteObject(buffer, this.state, true);
                break;
            case 8:
                AmqpEncoder.WriteBoolean(buffer, this.resume, true);
                break;
            case 9:
                AmqpEncoder.WriteBoolean(buffer, this.aborted, true);
                break;
            case 10:
    ...
    internal override void ReadField(ByteBuffer buffer, int index, byte formatCode)
    {
        switch (index)
        {
            case 0:
                ...
                break;
            case 1:
                this.deliveryId = AmqpEncoder.ReadUInt(buffer, formatCode);
                break;
            case 2:
                this.deliveryTag = AmqpEncoder.ReadBinary(buffer, formatCode);
                break;
            case 3:
                this.messageFormat = AmqpEncoder.ReadUInt(buffer, formatCode);
                break;
            case 4:
                this.settled = AmqpEncoder.ReadBoolean(buffer, formatCode);
                break;
            case 5:
                this.more = AmqpEncoder.ReadBoolean(buffer, formatCode);
                break;
            case 6:
                this.rcvSettleMode = (ReceiverSettleMode)AmqpEncoder.ReadUByte(buffer, formatCode);
                break;
            case 7:
                this.state = (DeliveryState)AmqpEncoder.ReadObject(buffer, formatCode);
                break;
            case 8:
                this.resume = AmqpEncoder.ReadBoolean(buffer, formatCode);
                break;
            case 9:
                this.aborted = AmqpEncoder.ReadBoolean(buffer, formatCode);
                break;
            case 10:

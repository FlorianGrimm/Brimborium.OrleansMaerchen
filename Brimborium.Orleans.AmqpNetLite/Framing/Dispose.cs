    ...
    internal override void WriteField(ByteBuffer buffer, int index)
    {
        switch (index)
        {
            case 0:
                ...
                break;
            case 1:
                AmqpEncoder.WriteUInt(buffer, this.first, true);
                break;
            case 2:
                AmqpEncoder.WriteUInt(buffer, this.last, true);
                break;
            case 3:
                AmqpEncoder.WriteBoolean(buffer, this.settled, true);
                break;
            case 4:
                AmqpEncoder.WriteObject(buffer, this.state);
                break;
            case 5:
    ...
    internal override void ReadField(ByteBuffer buffer, int index, byte formatCode)
    {
        switch (index)
        {
            case 0:
                ...
                break;
            case 1:
                this.first = AmqpEncoder.ReadUInt(buffer, formatCode);
                break;
            case 2:
                this.last = AmqpEncoder.ReadUInt(buffer, formatCode);
                break;
            case 3:

...
public sealed class Source : DescribedList
{
    ...
    internal override void WriteField(ByteBuffer buffer, int index)
    {
        ...
        {
            case 0:
                AmqpEncoder.WriteString(buffer, this.address, true);
                break;
            case 1:
                AmqpEncoder.WriteUInt(buffer, this.durable, true);
                break;
            case 2:
                AmqpEncoder.WriteSymbol(buffer, this.expiryPolicy, true);
                break;
            case 3:
                AmqpEncoder.WriteUInt(buffer, this.timeout, true);
                break;
            case 4:
                AmqpEncoder.WriteBoolean(buffer, this.dynamic, true);
                break;
            case 5:
                AmqpEncoder.WriteMap(buffer, this.dynamicNodeProperties, true);
                break;
            case 6:
                AmqpEncoder.WriteSymbol(buffer, this.distributionMode, true);
                break;
            case 7:
                AmqpEncoder.WriteMap(buffer, this.filterSet, true);
                break;
            case 8:
                AmqpEncoder.WriteObject(buffer, this.defaultOutcome, true);
                break;
            case 9:
                AmqpEncoder.WriteObject(buffer, this.outcomes, true);
                break;
            case 10:
    ...
    internal override void ReadField(ByteBuffer buffer, int index, byte formatCode)
    {
        ...
        {
            case 0:
                this.address = AmqpEncoder.ReadString(buffer, formatCode);
                break;
            case 1:
                this.durable = AmqpEncoder.ReadUInt(buffer, formatCode);
                break;
            case 2:
                this.expiryPolicy = AmqpEncoder.ReadSymbol(buffer, formatCode);
                break;
            case 3:
                this.timeout = AmqpEncoder.ReadUInt(buffer, formatCode);
                break;
            case 4:
                this.dynamic = AmqpEncoder.ReadBoolean(buffer, formatCode);
                break;
            case 5:
                this.dynamicNodeProperties = AmqpEncoder.ReadFields(buffer, formatCode);
                break;
            case 6:
                this.distributionMode = AmqpEncoder.ReadSymbol(buffer, formatCode);
                break;
            case 7:
                this.filterSet = AmqpEncoder.ReadMap(buffer, formatCode);
                break;
            case 8:
                this.defaultOutcome = (Outcome)AmqpEncoder.ReadObject(buffer, formatCode);
                break;
            case 9:
                this.outcomes = AmqpEncoder.ReadObject(buffer, formatCode);
                break;
            case 10:

...
public sealed class Properties : DescribedList
{
    ...
    internal override void WriteField(ByteBuffer buffer, int index)
    {
        ...
        {
            case 0:
                AmqpEncoder.WriteObject(buffer, this.messageId);
                break;
            case 1:
                AmqpEncoder.WriteBinary(buffer, this.userId, true);
                break;
            case 2:
                AmqpEncoder.WriteString(buffer, this.to, true);
                break;
            case 3:
                AmqpEncoder.WriteString(buffer, this.subject, true);
                break;
            case 4:
                AmqpEncoder.WriteString(buffer, this.replyTo, true);
                break;
            case 5:
                AmqpEncoder.WriteObject(buffer, this.correlationId);
                break;
            case 6:
                AmqpEncoder.WriteSymbol(buffer, this.contentType, true);
                break;
            case 7:
                AmqpEncoder.WriteSymbol(buffer, this.contentEncoding, true);
                break;
            case 8:
                AmqpEncoder.WriteTimestamp(buffer, this.absoluteExpiryTime);
                break;
            case 9:
                AmqpEncoder.WriteTimestamp(buffer, this.creationTime);
                break;
            case 10:
                AmqpEncoder.WriteString(buffer, this.groupId, true);
                break;
            case 11:
                AmqpEncoder.WriteUInt(buffer, this.groupSequence, true);
                break;
            case 12:
    ...
    internal override void ReadField(ByteBuffer buffer, int index, byte formatCode)
    {
        ...
        {
            case 0:
                this.messageId = AmqpEncoder.ReadObject(buffer, formatCode);
                break;
            case 1:
                this.userId = AmqpEncoder.ReadBinary(buffer, formatCode);
                break;
            case 2:
                this.to = AmqpEncoder.ReadString(buffer, formatCode);
                break;
            case 3:
                this.subject = AmqpEncoder.ReadString(buffer, formatCode);
                break;
            case 4:
                this.replyTo = AmqpEncoder.ReadString(buffer, formatCode);
                break;
            case 5:
                this.correlationId = AmqpEncoder.ReadObject(buffer, formatCode);
                break;
            case 6:
                this.contentType = AmqpEncoder.ReadSymbol(buffer, formatCode);
                break;
            case 7:
                this.contentEncoding = AmqpEncoder.ReadSymbol(buffer, formatCode);
                break;
            case 8:
                this.absoluteExpiryTime = AmqpEncoder.ReadTimestamp(buffer, formatCode);
                break;
            case 9:
                this.creationTime = AmqpEncoder.ReadTimestamp(buffer, formatCode);
                break;
            case 10:
                this.groupId = AmqpEncoder.ReadString(buffer, formatCode);
                break;
            case 11:
                this.groupSequence = AmqpEncoder.ReadUInt(buffer, formatCode);
                break;
            case 12:

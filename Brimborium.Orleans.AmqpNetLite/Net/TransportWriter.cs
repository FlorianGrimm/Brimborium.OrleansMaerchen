...
internal class TransportWriter : ITransport
{
    private readonly IAsyncTransport transport;
    private readonly Action<Exception> onException;
    private readonly Queue<ByteBuffer> bufferQueue;
    ...
    {
        private readonly TransportWriter writer;

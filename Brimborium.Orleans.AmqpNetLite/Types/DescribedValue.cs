...
public class DescribedValue : Described
{
    ...
    {
        AmqpEncoder.WriteObject(buffer, this.descriptor);
    }

    internal override void EncodeValue(ByteBuffer buffer)
    {
        AmqpEncoder.WriteObject(buffer, this.value);
    }

    internal override void DecodeDescriptor(ByteBuffer buffer)
    {
        this.descriptor = AmqpEncoder.ReadObject(buffer);
    }

    internal override void DecodeValue(ByteBuffer buffer)
    {
        this.value = AmqpEncoder.ReadObject(buffer);
    }

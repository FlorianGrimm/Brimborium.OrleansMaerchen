...
public class FailureDetails : IEquatable<FailureDetails> {
    ...
    public FailureDetails(Exception e)
        : this(e.GetType().FullName ?? string.Empty, GetErrorMessage(e), e.StackTrace, FromException(e.InnerException), false) {
    }
    ...
    public override bool Equals(object? other)
        => (other is FailureDetails failureDetails) ? this.Equals(failureDetails) : false;
...
#pragma warning restore IDE0041 // Use 'is null' check
    ...
    public override int GetHashCode() {
        return (this.ErrorType, this.ErrorMessage, this.StackTrace, this.InnerFailure).GetHashCode();
    }

...
public class ReflectionBasedTaskActivity : TaskActivity {
    ...
    public DataConverter DataConverter {
        ...
        set => this.dataConverter = value ?? throw new ArgumentNullException(nameof(value));
    }
    ...
    public override async Task<string> RunAsync(TaskContext context, string input) {
        ...
        try {
            object invocationResult = this.InvokeActivity(inputParameters, genericTypeArguments);
        ...
        if (exception != null) {
            ...
            if (context.ErrorPropagationMode == ErrorPropagationMode.SerializeExceptions) {
                details = Utils.SerializeCause(exception, this.DataConverter);
            } else {
    ...
    public virtual object InvokeActivity(object[] inputParameters, Type[] genericTypeParameters) {
        if (genericTypeParameters.Any()) {
            return this.MethodInfo.MakeGenericMethod(genericTypeParameters).Invoke(this.ActivityObject, inputParameters);
        }
